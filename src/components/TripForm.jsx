...
import { calculateForDestinations } from '../utils/calculator'
...
export default function TripForm({ onCalculate }) {
  ...
  const submit = (e) => {
    ...
    const results = calculateForDestinations({ ...form, nights: Number(form.nights), budget })
    onCalculate({ results, currency: form.currency, nights: Number(form.nights),
                  budget, adults: form.adults, children: form.children, hotelStars: form.hotel })
  }
